    ...
    <div>
      ...
      <Table
        ...
        columns={[
          ...
          { title: '单柜kW', width: 65, render: (_: unknown, r: BatchReportRow) => r.error ? '-' : r.input.cabinet_power },
          { title: '机柜数', width: 65, render: (_: unknown, r: BatchReportRow) => r.error ? '-' : r.input.total_cabinets },
