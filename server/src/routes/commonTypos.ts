...
export const PLACE_NAMES: CommonTypo[] = [
  ...
  // ===== 4 字组合（"XX 数据中心/机房" 等，防止 2 字边界漏检） =====
  { original: '苏洲数据中心', suggestion: '苏州数据中心', category: '地名' },
  { original: '哈尔并数据中心', suggestion: '哈尔滨数据中心', category: '地名' },
  { original: '北静数据中心', suggestion: '北京数据中心', category: '地名' },
  { original: '杭洲数据中心', suggestion: '杭州数据中心', category: '地名' },
  { original: '武汗数据中心', suggestion: '武汉数据中心', category: '地名' },
  { original: '哈尔并机房', suggestion: '哈尔滨机房', category: '地名' },
  { original: '苏洲机房', suggestion: '苏州机房', category: '地名' },
  { original: '武汗机房', suggestion: '武汉机房', category: '地名' },
  { original: '哈尔并市机房', suggestion: '哈尔滨市机房', category: '地名' },
  { original: '苏洲市机房', suggestion: '苏州市机房', category: '地名' },
